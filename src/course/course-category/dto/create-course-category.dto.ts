...
export class FaqItemDto {
  ...
  // 🟢 NEW: Status field
  @ApiProperty({
    description: 'The publishing status of the FAQ item.',
  ...
  @ApiProperty({
    description: 'Timestamp when the FAQ item was created (ISO format). This should typically be generated by the service.',
